...
save_tensorboard_log_path = os.path.join(parent_dir_path, 'log', 'tensorboard_cnn')
...
# model
def textcnn(max_sequence_length=max_reserved_vocab + 1, embedding_dim=embedding_dim, embedding_matrix=embedding_matrix,
